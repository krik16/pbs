...
<script src="${ctx}/js/bootstrap/bootstrap-select.min.js" type="text/javascript"></script>

<%--<link href="${ctx}/css/index.css" type="text/css" rel="stylesheet" />--%>
<link href="${ctx}/css/style.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/css/font-awesome.min.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/css/bootstrap-select.min.css" type="text/css" rel="stylesheet"/>
