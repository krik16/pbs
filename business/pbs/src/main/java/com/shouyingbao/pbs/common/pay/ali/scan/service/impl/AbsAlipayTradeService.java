package com.shouyingbao.pbs.common.pay.ali.scan.service.impl;
...
import com.shouyingbao.pbs.common.pay.ali.scan.config.Configs;
import com.shouyingbao.pbs.common.pay.ali.scan.config.Constants;
import com.shouyingbao.pbs.common.pay.ali.scan.model.TradeStatus;
import com.shouyingbao.pbs.common.pay.ali.scan.model.builder.AlipayTradePrecreateContentBuilder;
import com.shouyingbao.pbs.common.pay.ali.scan.model.builder.AlipayTradeQueryCententBuilder;
import com.shouyingbao.pbs.common.pay.ali.scan.model.builder.AlipayTradeRefundContentBuilder;
import com.shouyingbao.pbs.common.pay.ali.scan.model.result.AlipayF2FPrecreateResult;
...
abstract class AbsAlipayTradeService extends AbsAlipayService implements AlipayTradeService {
    ...
    public AlipayF2FQueryResult queryTradeResult(String outTradeNo) {
        ...
        }else if (TradeStatus.TRADE_CLOSED.toString().equals(response.getTradeStatus())) {
            result.setTradeStatus(TradeStatus.TRADE_CLOSED);
        } else {
            // 其他情况均表明该订单号交易失败
