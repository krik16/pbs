...
import com.shouyingbao.common.pay.weixin.util.RandomStringGenerator;
...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(String authCode, String body, String detail, String attach, String outTradeNo, int totalFee, String deviceInfo, String spBillCreateIP, String timeStart, String timeExpire, String goodsTag, Configure configure) {
